---
name: drafter
description: Generates implementation-agnostic kits from reference materials or existing code. Use when running /bp:draft-from-code or /bp:draft-from-refs commands.
model: opus
